...
const Footer = () => {
  return (
    <div className="footer xl:mt-12 bg-black/20 tracking-widest">
        ...
        <div className="flex w-full justify-between my-4 xl:w-6/12 xl:my-0">
          <div className="footer-col-3 w-6/12 xl:w-full space-y-4">
            ...
            <div className="flex items-center">
              ...
              <a
                href="https://www.instagram.com/abelparayil/"
                className="no-underline text-white text-xs block xl:text-sm"
                target="_blank">
                Instagram
              </a>
            ...
            <div className="flex items-center">
              ...
              <a
                href="https://www.linkedin.com/in/abelparayil/"
                className="no-underline text-white text-xs block xl:text-sm"
                target="_blank">
                LinkedIn
              </a>
            ...
            <div className="flex items-center">
              ...
              <a
                href="https://www.facebook.com/abelparayil"
                className="no-underline text-white text-xs block xl:text-sm"
                target="_blank">
                Facebook
              </a>
      ...
      <p className="text-white text-center mt-4 pb-4"></p>
    </div>
  );
};
